...
$(window).on("scroll", function () {
  ...
  if (
    Math.abs(distanceHeader) < Math.abs(distance1) &&
    Math.abs(distanceHeader) < Math.abs(distance2) &&
    Math.abs(distanceHeader) < Math.abs(distance3) &&
    Math.abs(distanceHeader) < Math.abs(distance4) &&
    Math.abs(distanceHeader) < Math.abs(distance5)
  ) {
    ...
    Math.abs(distance1) < Math.abs(distanceHeader) &&
    Math.abs(distance1) < Math.abs(distance2) &&
    Math.abs(distance1) < Math.abs(distance3) &&
    Math.abs(distance1) < Math.abs(distance4) &&
    Math.abs(distance1) < Math.abs(distance5)
  ) {
    ...
    Math.abs(distance2) < Math.abs(distanceHeader) &&
    Math.abs(distance2) < Math.abs(distance1) &&
    Math.abs(distance2) < Math.abs(distance3) &&
    Math.abs(distance2) < Math.abs(distance4) &&
    Math.abs(distance2) < Math.abs(distance5)
  ) {
    document.querySelector(".header-section").style.background = "#ff533d";
    document.querySelector(".section1").style.background = "#ff533d";
    ...
    Math.abs(distance3) < Math.abs(distanceHeader) &&
    Math.abs(distance3) < Math.abs(distance1) &&
    Math.abs(distance3) < Math.abs(distance2) &&
    Math.abs(distance3) < Math.abs(distance4) &&
    Math.abs(distance3) < Math.abs(distance5)
  ) {
    document.querySelector(".header-section").style.background = "#ff533d";
    document.querySelector(".section1").style.background = "#ff533d";
    document.querySelector(".section2").style.background = "#ff533d";
    ...
    Math.abs(distance4) < Math.abs(distanceHeader) &&
    Math.abs(distance4) < Math.abs(distance1) &&
    Math.abs(distance4) < Math.abs(distance2) &&
    Math.abs(distance4) < Math.abs(distance3) &&
    Math.abs(distance4) < Math.abs(distance5)
  ) {
    document.querySelector(".header-section").style.background = "#ff533d";
    document.querySelector(".section1").style.background = "#ff533d";
    document.querySelector(".section2").style.background = "#ff533d";
    ...
    Math.abs(distance5) < Math.abs(distanceHeader) &&
    Math.abs(distance5) < Math.abs(distance1) &&
    Math.abs(distance5) < Math.abs(distance2) &&
    Math.abs(distance5) < Math.abs(distance3) &&
    Math.abs(distance5) < Math.abs(distance4)
  ) {
    document.querySelector(".header-section").style.background = "#ff533d";
    document.querySelector(".section1").style.background = "#ff533d";
    document.querySelector(".section2").style.background = "#ff533d";
